...
function LogoutConfirmModal({ open, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white dark:bg-[var(--primary)] rounded-lg shadow-lg p-6 w-80 max-w-full">
        <h2 className="text-lg font-semibold mb-2 text-center text-[var(--accent)]">Confirm Logout</h2>
        <p className="mb-6 text-center text-[var(--neutral)] dark:text-[var(--neutral)]/80">Are you sure you want to logout?</p>
        <div className="flex justify-end gap-2">
          <button
            onClick={onCancel}
            className="px-4 py-2 rounded-md bg-[var(--secondary)] text-[var(--neutral)] hover:bg-[var(--neutral)]/20 transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="px-4 py-2 rounded-md bg-red-500 text-white hover:bg-red-600 transition-colors font-semibold"
          >
            Logout
          </button>
        </div>
